...
public class DBHelper1 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE record1 (_id INTEGER PRIMARY KEY AUTOINCREMENT," +
                "   date TEXT, name TEXT, factor INTEGER);");
        String before = settingshared.getString("before1", "설치전");
        sql=String.format("INSERT INTO record1 VALUES(NULL,'00:00','%s',0);",before);
        db.execSQL(sql);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS record1");
        onCreate(db);
    }
